...
const Home = () => {
  ...
  useEffect(() => {
    const discoverApi = `https://api.themoviedb.org/3/discover/movie?api_key=e46d5ba175a6d09d100586166d6ca8ac&include_adult=false&page=1`;
  ...
  const nextPage = () => {
    const discoverApi = `https://api.themoviedb.org/3/discover/movie?api_key=e46d5ba175a6d09d100586166d6ca8ac&include_adult=false&page=${
      currentPage + 1
    }`;
    fetchMovies(discoverApi);
  };
  ...
  return (
    <div className="homepage">
      <Navbar />
      <div className="homepage_title">Explore Movies</div>
