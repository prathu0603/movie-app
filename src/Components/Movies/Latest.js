...
const Latest = () => {
  ...
  useEffect(() => {
    const discoverApi = `https://api.themoviedb.org/3/movie/now_playing?api_key=e46d5ba175a6d09d100586166d6ca8ac&page=1`;
  ...
  const nextPage = () => {
    const discoverApi = `https://api.themoviedb.org/3/movie/now_playing?api_key=e46d5ba175a6d09d100586166d6ca8ac&page=${
      currentPage + 1
    }`;
    fetchMovies(discoverApi);
  };
  return (
    <div className="movie_page">
      <Navbar />
      <div className="homepage_title">Latest Release Movies</div>
